...
<div style="text-align: center;">
  <img src="{{ site.baseurl }}/assets/images/image-1.png" alt="Ski Agent" style="width: 80%;" />
  <p><em>Prompt chaining, the gate can me programmatic checks.</em></p>
</div>


<div style="text-align: center;">
  <img src="{{ site.baseurl }}/assets/images/image-2.png" alt="Ski Agent" style="width: 80%;" />
  <p><em>Routing</em></p>
</div>
